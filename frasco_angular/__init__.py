...
class AngularFeature(Feature):
    ...
    def build_routes(self):
        ...
        self.assets.append("@angular-route-cdn",
    ...
    def build_directives(self):
        ...
        files.append((filename, module))
        self.assets.append({"filters": "jsmin", "contents": [self.options["directives_file"]]})
    ...
    def build_app(self):
        ...
        self.assets.append({"filters": "jsmin", "contents": [self.options["app_file"]]})
    ...
    def build_services(self):
        ...
        module += "\n})();";
        self.assets.append("@angular-frasco",
