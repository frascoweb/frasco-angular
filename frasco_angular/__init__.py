...
class AngularFeature(Feature):
    ...
    def init_app(self, app):
        ...
        if self.options['auto_assets']:
            app.features.assets.add_default("@angular-cdn")
    ...
    def build_routes(self):
        ...
        self.app.assets.register("angular-auto-routes",
            {"filters": "jsmin", "contents": [self.options["routes_file"]]})
        if self.options['auto_assets']:
            self.app.features.assets.add_default("@angular-route-cdn", "@angular-auto-routes")
    ...
    def build_directives(self):
        ...
        files.append((filename, module))
        self.app.assets.register("angular-auto-directives", {
            "filters": "jsmin", "contents": [self.options["directives_file"]]})
        if self.options['auto_assets']:
            self.app.features.assets.add_default("@angular-auto-directives")
    ...
    def build_app(self):
        ...
        self.app.assets.register("angular-auto-app", {
            "filters": "jsmin", "contents": [self.options["app_file"]]})
        if self.options['auto_assets']:
            self.app.features.assets.add_default("@angular-auto-app")
    ...
    def build_services(self):
        ...
        module += "\n})();";
        self.app.assets.register("angular-auto-services", "@angular-frasco",
            {"filters": "jsmin", "contents": [self.options["services_file"]]})
        if self.options['auto_assets']:
            self.app.features.assets.add_default("@angular-auto-services")
